...
export default function Login() {
	...
	return (
		<form
			...
			className="min-w-84 flex flex-col gap-6 bg-white/60 border-white border-2 backdrop-blur-md p-4 rounded-xl"
		>
			...
			<p className="text-lg text-gray-600">
				...
				<Link href={"/register"} className="text-[#56A2E8] font-semibold">
					Register
				</Link>
			</p>
